...
//globals
var famousResolvers = []string{"1.0.0.1", "1.1.1.1", "149.112.112.112", "176.103.130.130", "176.103.130.131", "185.228.168.9", "185.228.169.9", "198.101.242.72", "208.67.220.220", "208.67.222.222", "23.253.163.53", "64.6.64.6", "64.6.65.6", "8.8.4.4", "8.8.8.8", "9.9.9.9"}
...
func checkJobProgress(d string, jobs *map[string]bool, dnsch chan string) {
	...
	if !ok {
		...
		debugLog("Need more wildcard results for verification:", len(wildcardDnsJob.Lookups))
		return
